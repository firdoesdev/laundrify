...
const reportMetrics: Metric[] = [
  { title: 'Monthly Revenue', value: '$4,820', icon: DollarSign, change: '+15.3%', changeType: 'positive' },
  ...
  { title: 'Average Order Value', value: '$61.79', icon: Percent, change: '-1.2%', changeType: 'negative' },
];
